...
from backend.evaluation.critic import critique
from backend.evaluation.structural import check_structural
from backend.memory.auto_memory import extract_and_upsert, load_hints
