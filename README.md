...
with guarded peer delegation + approval gates, adaptive learning (per-agent scoring,
Thompson routing off by default, Layer 4 memory consolidation), and feature flags (`ENABLE_*`
